...
namespace Group_Project_Draft
{
    public partial class Data : Form
    {
        ...
        public Data(string sport)
        {
            ...
            // Hides the logo boxes, only used for Lacrosse
        ...
        private void Data_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    // Placeholder for Basketball stuff
                    /*
                    this.basketballTableAdapter.Fill(this.sportsDataSet.Basketball);
                    currentBindingSource.DataSource = this.sportsDataSet.Basketball;
        ...
        // For Lacrosse to switch between the two tables
        ...
        // For Lacrosse, this is for the Player Table (that's the one that shows first)
        ...
        // Takes you to these websites to see more stuff
